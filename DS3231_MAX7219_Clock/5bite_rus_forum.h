// Взято отсюда: http://arduino.ru/forum/programmirovanie/parola-i-russkii-shrift
// Версия с форума, с удалёнными 208 и 209-ым символами.
// Заменил букву "в" на ту, которая в Font Builder v2 из библиотеки MD_MAX72xx 3.1.0
// Заменил знак градуса на 4 точки, т.к. он был слишком жирным
#pragma once

const PROGMEM uint8_t _5bite_rus[][6] =
{
{0},	// 0 - Empty Cell
